      ...
      <div class="profile-content">
        ...
        <section>
          ...
          <p>
            ...
            recognize your posts, comments and contributions easily!
          </p>
        ...
        <section>
          ...
          <form @submit.prevent="handleSubmit" class="password-form">
            ...
            <div class="input-group">
              ...
              <span class="error-message" v-if="errors.confirmation">{{
                errors.confirmation
              }}</span>
            </div>
...
const submit = async () => {
  try {
    ...
    updateMessage.value = "Email address is already taken.";
